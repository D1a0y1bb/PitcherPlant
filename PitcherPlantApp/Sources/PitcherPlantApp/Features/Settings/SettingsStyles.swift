...
extension SettingsRowIconStyle {
    ...
    static let reportLibrary = SettingsRowIconStyle(systemImage: "doc.text.magnifyingglass", color: .indigo)
    static let search = SettingsRowIconStyle(systemImage: "magnifyingglass", color: .blue)
    ...
    static let submissionImport = SettingsRowIconStyle(systemImage: "tray.and.arrow.down", color: .blue)
