...
enum LocalizationStrings {
    ...
    private static let zhHans: [String: String] = [
        ...
        "common.dark": "深色",
        "settings.title": "设置",
        "scrollEdgeLab.title": "滚动边缘测试",
        "scrollEdgeLab.description": "这个页面只用于验证系统标题栏的 scroll-edge 模糊效果，结构保持为最接近 Skills Hub 的 detail ScrollView。",
        "scrollEdgeLab.rowTitle": "测试段落 %lld",
        "scrollEdgeLab.rowBody": "滚动这段内容到窗口标题栏下方，观察系统是否以自然模糊吞入内容，而不是把文字透明叠在标题区域。",
    ...
    private static let english: [String: String] = [
        ...
        "sidebar.scrollEdgeLab": "Scroll Edge Lab",
        ...
        "scrollEdgeLab.title": "Scroll Edge Lab",
        "scrollEdgeLab.description": "This page only validates the system titlebar scroll-edge blur. Its structure intentionally stays close to the Skills Hub detail ScrollView.",
        "scrollEdgeLab.rowTitle": "Test Paragraph %lld",
        "scrollEdgeLab.rowBody": "Scroll this content under the window titlebar and check whether the system naturally blurs it instead of transparently stacking text in the title area.",
