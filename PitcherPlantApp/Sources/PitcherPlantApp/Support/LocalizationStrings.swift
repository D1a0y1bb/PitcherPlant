...
enum LocalizationStrings {
    ...
    private static let zhHans: [String: String] = [
        ...
        "toolbar.cancel": "取消",
        "toolbar.settings": "设置",
        "toolbar.showInspector": "显示检查器",
        "toolbar.hideInspector": "隐藏检查器",
        ...
        "audit.validation.reportNameTemplateInvalid": "报告文件名模板无效：%@。请只使用文件名，不要包含路径、..、/ 或 \\。",
        ...
        "history.emptyDescription": "开始一次审计或导入提交包后，任务会显示在这里。",
        ...
        "settings.auditAssistantDataSharingDescription": "控制发送给外部模型的证据范围；仅在 API Key 模式启用时外发",
        ...
        "settings.reportIssue": "报告错误",
        "settings.reportIssueDescription": "提交你在使用 PitcherPlant 时遇到的问题",
        "settings.reportIssueTitle": "报告应用问题",
        "settings.reportIssuePrompt": "发生了什么？",
        "settings.reportIssuePlaceholder": "请描述你遇到的问题",
        "settings.reportIssueReviewNote": "提交内容会带上应用版本和 macOS 版本，方便定位问题。",
        "settings.reportIssueIncludeScreenshot": "在报告中包含屏幕截图",
        "settings.reportIssueScreenshotCapturing": "正在截取当前 App 窗口…",
        "settings.reportIssueScreenshotReady": "已截取当前 App 窗口。GitHub 页面打开后，请手动上传这张截图；提交内容会写入图片文件位置。",
        "settings.reportIssueScreenshotDenied": "未获得屏幕录制权限，无法自动截取当前 App 窗口。",
        "settings.reportIssueScreenshotUnavailable": "没有找到可截取的 App 窗口。",
        "settings.reportIssueScreenshotFailed": "截图失败，请稍后重试。",
        "settings.reportIssueSubmit": "提交",
        "settings.helpCenter": "帮助中心",
        "settings.helpCenterDescription": "查看 PitcherPlant 的使用说明",
        "settings.helpCenterBody": "PitcherPlant 是本地优先的 macOS WriteUP 审计工作台。常用流程是选择审计目录，导入提交包，运行审计，在报告中心复核证据并导出结果。报告、证据、指纹和白名单数据保存在本机工作区数据库中。",
        "settings.termsOfUse": "使用条款",
        "settings.termsOfUseDescription": "查看应用使用规则",
        "settings.termsOfUseBody": "PitcherPlant 用于辅助安全竞赛 WriteUP 审查。应用输出只作为人工复核依据，最终判断仍应结合比赛规则、上下文和人工确认。请不要用本应用处理你无权审查的数据。",
        "settings.privacyPolicy": "隐私政策",
        "settings.privacyPolicyDescription": "查看本地数据和隐私说明",
        "settings.privacyPolicyBody": "PitcherPlant 默认在本机处理审计数据，并把数据库、报告和配置保存到本机工作区。除非你主动打开更新检查、提交错误报告、访问外部链接，或在 API Key 模式下请求审计助手分析，应用不会主动上传你的审计内容。使用审计助手外部 API 时，应用可能会按“外发数据”设置，把证据摘要、证据详情或完整上下文发送给你配置的外部模型提供方；API Key 只保存到 macOS Keychain。",
        "settings.infoApp": "应用",
        "settings.infoVersion": "版本",
        "settings.infoBundle": "标识符",
        ...
        "reports.copyAssistantResult": "复制助手结果",
        "reports.applyAssistantNote": "应用备注草稿",
        "reports.applyAssistantSeverity": "应用结论和级别",
        ...
        "reports.assistantLocalSummary": "%@ 命中%@，系统风险等级为%@，当前复核状态为%@。",
        "reports.assistantLocalCheckpoint.context": "核对详情面板中的上下文",
        "reports.assistantLocalCheckpoint.attachments": "检查代码片段和附件来源",
        "reports.assistantLocalCheckpoint.whitelist": "确认是否已有白名单或人工复核记录",
        "reports.assistantLocalNoteDraft": "%@ 建议继续人工复核原始证据。",
        "reports.assistantConnectionTestTitle": "审计助手连接测试",
        "reports.assistantConnectionTestBody": "请返回一段简短的连接测试结果。",
        "reports.assistantConnectionTestBadge": "连接测试",
        "assistant.error.disabled": "审计助手已关闭。",
        "assistant.error.invalidEndpoint": "API 地址格式无效。",
        "assistant.error.missingModel": "缺少模型名称。",
        "assistant.error.missingCredential": "缺少审计助手 API Key。",
        "assistant.error.emptyResponse": "审计助手没有返回内容。",
        "assistant.error.timeout": "审计助手执行超时。",
        "assistant.error.httpStatus": "外部 API 返回 HTTP %d：%@",
        "assistant.error.unsupportedProviderProtocol": "%@ 不支持 %@ 接口协议。",
        "assistant.error.unsupportedResponse": "无法解析外部 API 响应：%@",
        "assistant.error.responseTooLarge": "外部 API 响应过大。",
        "assistant.error.noDisplayContent": "审计助手没有返回可显示内容。",
        "assistant.error.missingHTTPResponse": "缺少 HTTP 响应。",
        "assistant.keychain.missingCredential": "缺少审计助手 API Key。",
        "assistant.keychain.encodingFailed": "API Key 编码失败。",
        "assistant.keychain.failure": "Keychain 操作失败：%d。",
    ...
    private static let english: [String: String] = [
        ...
        "audit.submissionPackage": "Competition Package",
        ...
        "audit.validation.reportNameTemplateInvalid": "The report file name template is invalid: %@. Use a file name only; do not include paths, .., /, or \\.",
        "audit.validation.numberRange": "%@ must be within %@.",
        "mode.mark": "Mark",
        "mode.hide": "Hide",
        "history.searchPrompt": "Search task, path, or status",
        "history.tasks": "Task List",
        "history.empty": "No History Tasks",
        "history.emptyDescription": "Audits and imported submission packages appear here.",
        ...
        "job.failureCountShort": "%d failed",
        ...
        "settings.auditAssistantDataSharingDescription": "Controls how much evidence is sent to external models when API Key mode is enabled",
        "settings.auditAssistantAPIKey": "API Key",
        ...
        "settings.reportIssueDescription": "Submit a problem you ran into while using PitcherPlant",
        "settings.reportIssueTitle": "Report App Issue",
        "settings.reportIssuePrompt": "What happened?",
        "settings.reportIssuePlaceholder": "Describe the issue you encountered",
        "settings.reportIssueReviewNote": "The report includes the app version and macOS version to help with review.",
        "settings.reportIssueIncludeScreenshot": "Include screenshot in report",
        "settings.reportIssueScreenshotCapturing": "Capturing the current app window...",
        "settings.reportIssueScreenshotReady": "The current app window was captured. Upload this screenshot manually after the GitHub page opens; the report body includes the image file path.",
        "settings.reportIssueScreenshotDenied": "Screen Recording permission was not granted, so the app window could not be captured.",
        "settings.reportIssueScreenshotUnavailable": "No capturable app window was found.",
        "settings.reportIssueScreenshotFailed": "Screenshot capture failed. Try again later.",
        "settings.reportIssueSubmit": "Submit",
        "settings.helpCenter": "Help Center",
        "settings.helpCenterDescription": "View PitcherPlant usage guidance",
        "settings.helpCenterBody": "PitcherPlant is a local-first macOS WriteUP audit workstation. A typical flow is choosing an audit directory, importing submission packages, running audits, reviewing evidence in Reports, and exporting results. Reports, evidence, fingerprints, and whitelist data are stored in the local workspace database.",
        "settings.termsOfUse": "Terms of Use",
        "settings.termsOfUseDescription": "View app usage terms",
        "settings.termsOfUseBody": "PitcherPlant is designed to assist security competition WriteUP review. App output is decision support for human reviewers, and final decisions should still consider competition rules, context, and manual verification. Do not use this app to process data you are not authorized to review.",
        "settings.privacyPolicy": "Privacy Policy",
        "settings.privacyPolicyDescription": "View local data and privacy notes",
        "settings.privacyPolicyBody": "PitcherPlant processes audit data locally by default and stores databases, reports, and configuration in the local workspace. Unless you manually check for updates, submit an issue, open an external link, or request Audit Assistant analysis in API Key mode, the app does not upload your audit content. When you use the Audit Assistant external API, the app may send evidence summaries, evidence details, or full context to the external models provider you configure according to the Shared Data setting; API keys are stored only in macOS Keychain.",
        "settings.infoApp": "App",
        "settings.infoVersion": "Version",
        "settings.infoBundle": "Bundle ID",
        ...
        "reports.sectionCount": "%d sections",
        ...
        "reports.copyAssistantResult": "Copy Assistant Result",
        "reports.applyAssistantNote": "Apply Note Draft",
        "reports.applyAssistantSeverity": "Apply Decision and Severity",
        ...
        "reports.assistantLocalSummary": "%@ matched %@. System risk: %@. Current review status: %@.",
        "reports.assistantLocalCheckpoint.context": "Check the context in the detail panel",
        "reports.assistantLocalCheckpoint.attachments": "Review code snippets and attachment sources",
        "reports.assistantLocalCheckpoint.whitelist": "Confirm whether a whitelist or manual review already exists",
        "reports.assistantLocalNoteDraft": "%@ Continue manual review of the original evidence.",
        "reports.assistantConnectionTestTitle": "Audit Assistant Connection Test",
        "reports.assistantConnectionTestBody": "Return a short connection test result.",
        "reports.assistantConnectionTestBadge": "Connection Test",
        "assistant.error.disabled": "Audit Assistant is disabled.",
        "assistant.error.invalidEndpoint": "The API URL is invalid.",
        "assistant.error.missingModel": "Missing model name.",
        "assistant.error.missingCredential": "Missing Audit Assistant API key.",
        "assistant.error.emptyResponse": "Audit Assistant returned no content.",
        "assistant.error.timeout": "Audit Assistant timed out.",
        "assistant.error.httpStatus": "External API returned HTTP %d: %@",
        "assistant.error.unsupportedProviderProtocol": "%@ does not support the %@ API protocol.",
        "assistant.error.unsupportedResponse": "Could not parse external API response: %@",
        "assistant.error.responseTooLarge": "External API response is too large.",
        "assistant.error.noDisplayContent": "Audit Assistant returned no displayable content.",
        "assistant.error.missingHTTPResponse": "Missing HTTP response.",
        "assistant.keychain.missingCredential": "Missing Audit Assistant API key.",
        "assistant.keychain.encodingFailed": "API key encoding failed.",
        "assistant.keychain.failure": "Keychain operation failed: %d.",
