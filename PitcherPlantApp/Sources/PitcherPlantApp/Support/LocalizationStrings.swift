...
enum LocalizationStrings {
    ...
    private static let zhHans: [String: String] = [
        ...
        "settings.defaultPageDescription": "打开主窗口时默认展示的页面",
        ...
        "settings.theme": "外观模式",
        "settings.themeDescription": "跟随系统或固定浅色、深色",
    ...
    private static let english: [String: String] = [
        ...
        "settings.defaultPageDescription": "Page shown when the main window opens",
        ...
        "settings.themeDescription": "Follow the system appearance or pin light/dark mode",
