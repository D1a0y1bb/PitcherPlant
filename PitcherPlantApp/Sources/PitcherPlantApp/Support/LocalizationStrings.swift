...
enum LocalizationStrings {
    ...
    private static let zhHans: [String: String] = [
        ...
        "settings.privacyPolicyBody": "PitcherPlant 默认在本机处理审计数据，并把数据库、报告和配置保存到本机工作区。除非你主动打开更新检查、提交错误报告或访问外部链接，应用不会主动上传你的审计内容。",
        "settings.infoApp": "应用",
    ...
    private static let english: [String: String] = [
        ...
        "settings.privacyPolicyBody": "PitcherPlant processes audit data locally by default and stores databases, reports, and configuration in the local workspace. Unless you manually check for updates, submit an issue, or open an external link, the app does not upload your audit content.",
